...
func (*VantagePoint) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*VPRequest) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{1} }
...
func (*VPReturn) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{2} }
...
func (*RRSpooferRequest) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{3} }
...
func (*RRSpooferResponse) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{4} }
...
func (*TSSpooferRequest) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{5} }
...
func (*TSSpooferResponse) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{6} }
